...
const (
	...
	ErrPalavraExistente   = ErrDicionario("Poxa essa Palavra ja tem uma definição!")
	ErrPalavraInexistente = ErrDicionario("Erro de palavra Inexistente para atualizar")
)
